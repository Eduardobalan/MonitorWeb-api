...
public class UsuarioHasDominioServerTest extends GenericTest{
    ...
    public void buscarTodosTest() throws Exception {
        mockMvc.perform(get("/usuariohasdominio"))
                ...
                .andExpect(jsonPath("$[0].usuario.dtHrCadastro", is("2017-02-28T04:00:00.000+0000")))
                ...
                .andExpect(jsonPath("$[1].usuario.dtHrCadastro", is("2017-02-28T04:00:00.000+0000")))
                ...
                .andExpect(jsonPath("$[2].usuario.dtHrCadastro", is("2017-02-28T04:00:00.000+0000")))
